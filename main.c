...
/*
#define WATCH_TASK_PRIO			7
//任务堆栈大小
#define WATCH_STK_SIZE			128
//任务控制块
OS_TCB WatchTaskTCB;
//任务堆栈
CPU_STK WATCH_TASK_STK[WATCH_STK_SIZE];
//emwindemo_task任务
void watch_task(void *p_arg);
*/
...
void start_task(void *p_arg)
{
   ...
   OSStatTaskCPUUsageInit(&err);  	//统计任务                
	...
	OSTaskCreate((OS_TCB*     )&EmwindemoTaskTCB,		
                 ...
                 (OS_ERR*     )&err);
			/*					 
								 	OSTaskCreate((OS_TCB*     )&WatchTaskTCB,		
				 (CPU_CHAR*   )"Watch task", 		
...
/*void watch_task(void *p_arg)
{
		...
		while(1)
		{
			...
			sprintf(text_buffer,"MUSIC player                  CPU:%02d%%",(uint8_t)(OSStatTaskCPUUsage/100));
			FRAMEWIN_SetText(hWin1, text_buffer);
		}
}*/
